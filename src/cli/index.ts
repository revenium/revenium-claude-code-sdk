...
program
  ...
  .option(
    "-t, --tier <tier>",
    "Subscription tier (professional, max, team, enterprise, api)",
  )
  ...
  .option('--extra-usage-enabled', 'Set CLAUDE_CODE_EXTRA_USAGE_ENABLED=1 in SDK config (indicates org allows usage beyond subscription limits)')
