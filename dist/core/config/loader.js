...
async function loadConfig() {
    ...
    try {
        ...
        return {
            ...
            subscriptionTier: (env[constants_js_1.ENV_VARS.SUBSCRIPTION_TIER] || env[constants_js_1.ENV_VARS.SUBSCRIPTION]),
            organizationName,
            ...
            extraUsageEnabled: env[constants_js_1.ENV_VARS.EXTRA_USAGE_ENABLED] === '1'
                ? true
                : env[constants_js_1.ENV_VARS.EXTRA_USAGE_ENABLED] === '0'
                    ? false
                    : undefined,
        };
    }
